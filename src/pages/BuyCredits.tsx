  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-purple-900/20 to-black">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-64 md:w-96 h-64 md:h-96 bg-yellow-500/10 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-64 md:w-96 h-64 md:h-96 bg-pink-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
      </div>
      ...
      <div className="relative container mx-auto px-4 py-6 md:py-12 space-y-8 md:space-y-12">
        ...
        <motion.div
          ...
          className="max-w-md mx-auto bg-gradient-to-r from-yellow-500/20 to-pink-500/20 rounded-xl md:rounded-2xl p-6 md:p-8 border-2 border-yellow-400/50 text-center"
        >
          <p className="text-gray-300 mb-2 text-sm md:text-base">{t('credits.yourCredits')}</p>
          <div className="flex items-center justify-center gap-2 md:gap-3">
            <Zap className="w-10 h-10 md:w-12 md:h-12 text-yellow-400" />
            <span className="text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-pink-500">
              {user.credits}
            </span>
          </div>
          <p className="text-gray-400 mt-2 text-sm md:text-base">{t('credits.bids')}</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
          {packs.map((pack, index) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className={`relative bg-gradient-to-br from-purple-900/50 to-pink-900/50 rounded-xl md:rounded-2xl p-6 md:p-8 border-2 ${
            ...
            >
              ...
              <div className="text-center space-y-4 md:space-y-6">
                ...
                <div className="flex justify-center">
                  <div className="bg-gradient-to-br from-yellow-500/20 to-pink-500/20 p-4 md:p-6 rounded-full border-2 border-yellow-400/50">
                    <Zap className="w-12 h-12 md:w-16 md:h-16 text-yellow-400" />
                  </div>
                </div>
                ...
                {/* Price */}
                <div className="bg-black/40 rounded-lg md:rounded-xl p-3 md:p-4 border border-purple-500/30">
                ...
                <motion.button
                  ...
                  className={`w-full font-black text-base md:text-lg py-3 md:py-4 rounded-lg md:rounded-xl transition-all uppercase flex items-center justify-center gap-2 ${
                    pack.popular
